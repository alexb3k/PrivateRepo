...
.PARAMETER All
    Installs all the features within RSAT. This takes several minutes, depending on the Internet connection
.PARAMETER Basic
...
.NOTES
    ...
    Author: Alex Andrei
    Version history:
    1.0   -   Script shamelesly copied from the internet
    1.1   -   Modified to fit template
