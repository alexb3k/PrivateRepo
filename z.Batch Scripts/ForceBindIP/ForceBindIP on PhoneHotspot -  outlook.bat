...
for /f "usebackq tokens=*" %%a in (`ipconfig ^| findstr /c:"IPv4 Address. . . . . . . . . . . : 192.168"`) do (
  ...
  for /f delims^=^:^ tokens^=2 %%b in ('echo %%a') do (
    ...
    for /f "tokens=1-4 delims=." %%c in ("%%b") do (
      ...
      set _ip=!_o1:~1!.!_o2!.!_o3!.!_o4!    
      )
    )
  )
set _outlook="C:\Program Files\Microsoft Office\root\Office16\OUTLOOK.EXE"
cd "C:\Program Files (x86)\ForceBindIP\"

forcebindip64.exe !_ip! !_outlook!
